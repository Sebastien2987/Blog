...
<div class="post_comment">
        <form action="index.php?action=editPost&id=<?php echo $_GET['id'];?>" method="post">
            <p>
            Titre : <input type="text" name="title" style="width: 100%;" value="<?php echo $selecteditreq['title'];?>" /><br />
            Contenu :<br />
            <textarea rows="10" cols="50" name="content" style="width: 100%;" /><?php echo $selecteditreq['content']; ?></textarea><br />
